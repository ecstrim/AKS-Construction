...
resource ruleAppGwManagement 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleInAllowGwManagement) {
  parent: nsg
...
resource ruleAzureLoadBalancer 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if (ruleInAllowAzureLoadBalancer) {
  parent: nsg
...
resource ruleDenyInternet 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleInDenyInternet) {
  parent: nsg
...
resource ruleInternetHttp 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleInAllowInternetHttp) {
  parent: nsg
...
resource ruleInternetHttps 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleInAllowInternetHttps) {
  parent: nsg
...
resource ruleBastionHost 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleInAllowBastionHostComms) {
  parent: nsg
...
resource ruleBastionEgressSshRdp 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleOutAllowBastionComms) {
  parent: nsg
...
resource ruleBastionEgressAzure 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleOutAllowBastionComms) {
  parent: nsg
...
resource ruleBastionEgressBastionComms 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleOutAllowBastionComms) {
  parent: nsg
...
resource ruleBastionEgressSessionInfo 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleOutAllowBastionComms) {
  parent: nsg
...
resource ruleSshIngressDeny 'Microsoft.Network/networkSecurityGroups/securityRules@2023-11-01' = if(ruleInDenySsh) {
  parent: nsg
  name: 'DenySshInbound'
  properties: {
    protocol: '*'
